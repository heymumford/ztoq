...
def upgrade() -> None:
    ...
    sa.Column('entity_type', sa.Enum('TEST_CASE', 'TEST_EXECUTION', 'TEST_STEP', 'TEST_CYCLE', 'TEST_PLAN', 'FOLDER', name='entitytype'), nullable=False),
    sa.Column('entity_id', sa.String(length=50), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_attachment_entity', 'attachments', ['entity_type', 'entity_id'], unique=False)
    ...
    op.create_table('entity_batch_state',
    ...
    op.create_index(op.f('ix_entity_batch_state_project_key'), 'entity_batch_state', ['project_key'], unique=False)
    ...
    op.create_index(op.f('ix_migration_state_project_key'), 'migration_state', ['project_key'], unique=True)
    ...
    op.create_index('idx_custom_field_project', 'custom_field_definitions', ['project_key'], unique=False)
    ...
    op.create_index('idx_custom_field_value_entity', 'custom_field_values', ['entity_type', 'entity_id'], unique=False)
    op.create_index('idx_custom_field_value_field', 'custom_field_values', ['field_id'], unique=False)
    ...
    op.create_table('case_label_association',
    ...
    op.create_index('idx_case_label', 'case_label_association', ['test_case_id', 'label_id'], unique=False)
    op.create_table('case_version_association',
    sa.Column('test_case_id', sa.String(length=50), nullable=True),
    ...
    op.create_index('idx_case_version', 'case_version_association', ['test_case_id', 'version_id'], unique=False)
    ...
    op.create_index('idx_test_execution_environment', 'test_executions', ['environment_id'], unique=False)
