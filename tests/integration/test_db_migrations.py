...
from ztoq.core.db_models import Base, Project, TestCase, Folder, Status
from ztoq.models import Project as ProjectModel, Case as CaseModel
    ...
    def test_migration_failure_and_recovery(self, temp_db_path, db_manager):
        ...
        with db_manager.get_session() as session:
            try:
                ...
                session.execute(text("UPDATE projects SET recovery_test = 'recovered' WHERE key LIKE 'FAIL%'"))
                session.commit()
