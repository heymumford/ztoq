...
class TestQTestModelValidations:
    ...
    def test_qtest_config_validation(self):
        ...
        with pytest.raises(ValidationError) as excinfo:
            QTestConfig(base_url="not a valid url", username="test_user", password="test_password")
    ...
    def test_project_validation(self):
        ...
        with pytest.raises(ValidationError) as excinfo:
            QTestProject(id=12345, description="Test Project Description", status="active")
...
class TestPaginatedResponse:
    ...
    def test_paginated_response_parsing(self):
        ...
        test_cases_data = {
            ...
            "total": 25,
            "items": [
                {"id": 201, "name": "Test Case 1", "projectId": 12345, "moduleId": 101},
                {"id": 202, "name": "Test Case 2", "projectId": 12345, "moduleId": 101},
            ],
        }
    ...
    def test_paginated_response_navigation(self):
        ...
        # Test first page
        first_page = QTestPaginatedResponse(page=1, pageSize=10, total=25, items=[])
        ...
        # Test last page
        last_page = QTestPaginatedResponse(page=3, pageSize=10, total=25, items=[])
