    ...
    def test_save_all_projects_data(self, db_manager):
        ...
        test_cases2 = [
            Case(
                id="tc2",
                key="PROJ2-1",
                name="Test 1 for Project 2"
            ),
            Case(
                id="tc3",
                key="PROJ2-2",
                name="Test 2 for Project 2"
            )
        ]
        ...
        with patch.object(db_manager, 'initialize_database', wraps=db_manager.initialize_database) as mock_init_db:
