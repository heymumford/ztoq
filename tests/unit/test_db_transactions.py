...
from ztoq.core.db_models import (
    Base, Project, Folder, TestCase, TestCycle, TestExecution
)
...
class TestDatabaseTransactions:
    ...
    def test_transaction_error_handling_in_manager_methods(self, db_manager):
        ...
        original_save = db_manager.save_test_cycle
    ...
    def test_transaction_error_in_nested_operation(self, db_manager):
        ...
        with patch.object(db_manager, '_save_custom_fields') as mock_save_custom_fields:
            ...
            mock_save_custom_fields.side_effect = SQLAlchemyError("Simulated error in nested operation")
