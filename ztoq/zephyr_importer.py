...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("zephyr_import.log")
    ]
)
    ...
    def project_callback(
        ...
        if event_type == "project_start":
            ...
            if self.verbose:
                ...
                print(f"\rProjects: {self.projects_completed}/{self.projects_total} ({progress:.1f}%)", end="")
